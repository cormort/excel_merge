const ExcelViewer = (() => {
    ...
    function closeMergeView() {
        ...
        state.showSourceColumn = false; // <-- RESET STATE
        elements.toggleSourceColBtn.textContent = '新增來源欄位'; // <-- RESET BUTTON TEXT
        elements.toggleSourceColBtn.classList.remove('active'); // <-- RESET BUTTON STYLE
        state.mergedData = [];
        state.mergedHeaders = [];
