...
                .map((th, i) => th.textContent.trim() || `(欄位 ${i + 1})`);
    ...
    function applyColumnChanges() {
        ...
        headers.forEach((th, index) => {
            ...
            const colIndex = index + 2; // +1 for checkbox cell, +1 for nth-child selector
